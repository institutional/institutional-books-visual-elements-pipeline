...
from .step07_dedupe_embedding import step07_dedupe_embedding
from .step08_analyze import step08_analyze
...
steps.add_command(step07_dedupe_embedding)
steps.add_command(step08_analyze)
